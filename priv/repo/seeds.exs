...
Repo.insert!(%Job{jobcode: "Job1", desc: "This is job 1", user_id: 1})
Repo.insert!(%Job{jobcode: "Job2", desc: "This is job 2", user_id: 1})
Repo.insert!(%Job{jobcode: "Job3", desc: "This is job 3", user_id: 1})
Repo.insert!(%Job{jobcode: "Job4", desc: "This is job 4", user_id: 2})
Repo.insert!(%Job{jobcode: "Job5", desc: "This is job 5", user_id: 2})
Repo.insert!(%Job{jobcode: "Job6", desc: "This is job 6", user_id: 3})