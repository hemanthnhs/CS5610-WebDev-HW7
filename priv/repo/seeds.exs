...
Repo.insert!(%Job{jobcode: "Job1", user_id: 1})
Repo.insert!(%Job{jobcode: "Job2", user_id: 1})
Repo.insert!(%Job{jobcode: "Job3", user_id: 1})
Repo.insert!(%Job{jobcode: "Job4", user_id: 2})
Repo.insert!(%Job{jobcode: "Job5", user_id: 2})
Repo.insert!(%Job{jobcode: "Job6", user_id: 3})
Repo.insert!(%Job{jobcode: "Job7", user_id: 1})
Repo.insert!(%Job{jobcode: "Job8", user_id: 1})